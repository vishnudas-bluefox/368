...
<div class="postbuttons mb-0">
  <div class=" d-flex align-items-center justify-content-center container-fluid" style="height: 50px;">
    <button type="button" style="margin: auto" class=" buttontransperent"onclick='upvote("ufirstpost")'><i class="fas fa-arrow-circle-up fa-2x"></i><h3 id="ufirstpost" style="display: inline;margin-left: 5px;"></h3>${data[i].like}</button>
    <button type="button" style="margin: auto" class=" buttontransperent"onclick='downvote("dfirstpost")'><i class="fas fa-arrow-circle-down fa-2x"></i><h3 id="dfirstpost" style="display: inline;margin-left: 5px;"></h3>${data[i].dislike}</button>
